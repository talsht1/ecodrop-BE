...
FROM (
  VALUES
    ('Downtown Recycling Hub', '350 Fifth Avenue, New York, NY', 'mixed', ST_SetSRID(ST_MakePoint(-73.9857, 40.7484), 4326)),
    ...
    ('Union Square Plastic Point', 'Union Square Park, New York, NY', 'plastic', ST_SetSRID(ST_MakePoint(-73.9911, 40.7359), 4326)),
    ('Washington Square Mixed Point', 'Washington Square Park, New York, NY', 'mixed', ST_SetSRID(ST_MakePoint(-73.9973, 40.7308), 4326)),
    ('Flatiron Metal Point', '175 Fifth Avenue, New York, NY', 'metal', ST_SetSRID(ST_MakePoint(-73.9897, 40.7411), 4326)),
    ...
    ('Lincoln Center Plastic Point', 'Lincoln Center Plaza, New York, NY', 'plastic', ST_SetSRID(ST_MakePoint(-73.9835, 40.7725), 4326)),
    ('Museum Mile Metal Point', '1000 Fifth Avenue, New York, NY', 'metal', ST_SetSRID(ST_MakePoint(-73.9632, 40.7794), 4326)),
    ('Madison Square Mixed Point', 'Madison Square Park, New York, NY', 'mixed', ST_SetSRID(ST_MakePoint(-73.9880, 40.7420), 4326)),
    ('Harlem Electronics Point', '253 West 125th Street, New York, NY', 'electronics', ST_SetSRID(ST_MakePoint(-73.9500, 40.8100), 4326)),
    ('Morningside Heights Plastic Point', '116th Street and Broadway, New York, NY', 'plastic', ST_SetSRID(ST_MakePoint(-73.9626, 40.8075), 4326)),
    ('Fort Tryon Metal Point', 'Fort Tryon Park, New York, NY', 'metal', ST_SetSRID(ST_MakePoint(-73.9313, 40.8617), 4326)),
    ...
    ('Moran Mixed Demo Point', 'Mock location 1, Moran, Misgav, Israel', 'mixed', ST_SetSRID(ST_MakePoint(35.3956, 32.9194), 4326)),
